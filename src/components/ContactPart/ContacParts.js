            ...
            <div className="rounded shadow mb-5 bg-body">
              ...
              <div className="d-flex p-5">
                <div>
                  <a href="">
                    <i
                      className="fa-solid fa-store fs-4 me-3 pt-1"
                      style={{ color: "#c39f57" }}
                    ></i>
                  </a>
                </div>
                <div>
                  <h5 className="fw-semibold fs-4" style={{ color: "#333333" }}>
                    Yan Horizon Store
                  </h5>
                  <p className="fw-normal fs-6" style={{ color: "#6c757d" }}>
                    2no gate, Nasirabad, Chittagong
                  </p>
                  <p className="fw-normal fs-6" style={{ color: "#6c757d" }}>
                    Email: yanhorizon@gmail.com
                  </p>
                  <p className="fw-normal fs-6" style={{ color: "#6c757d" }}>
                    Tel: 01812144345
                  </p>
